...
`}</pre>
        <div className="space-y-1">
          <div className="whitespace-pre">
            <span className="text-[var(--accent)]">{"user".padEnd(10, " ")}</span>
            <span className="text-[var(--fg)]">ricky</span>
          </div>
          <div className="whitespace-pre">
            <span className="text-[var(--accent)]">{"role".padEnd(10, " ")}</span>
            <a
          ...
          <div className="whitespace-pre">
            <span className="text-[var(--accent)]">{"focus".padEnd(10, " ")}</span>
